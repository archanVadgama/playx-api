...
_a = UserController;
UserController.getFeedData = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const feedDataWithCustomPaths = feedData.map((video) =>
        Object.assign(Object.assign({}, video), {
...
UserController.getVideo = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const feedDataWithCustomPaths = Object.assign(Object.assign({}, videoData), {
...
UserController.uploadVideo = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const videoFile =
        (_b = files === null || files === void 0 ? void 0 : files["video"]) === null || _b === void 0
          ? void 0
          : _b[0];
      const thumbnailFile =
        (_c = files === null || files === void 0 ? void 0 : files["thumbnail"]) === null || _c === void 0
          ? void 0
          : _c[0];
      if (!videoFile) {

 ...
 * @memberof AuthController
 */
AuthController.refreshTokenHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c;
 ...
 * @memberof AuthController
 */
AuthController.logOutHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
 ...
 * @memberof AuthController
 */
AuthController.forgotPasswordHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = validationResult(req);
    if (!result.isEmpty()) {
        res
            .status(StatusCodes.BAD_REQUEST)
    ...
    try {
        ...
        sendMail(getUser.email, getUser.displayName, `${ENV.FRONTEND_URL}/reset-password/${JWT_TOKEN.accessToken}`);
 ...
 * @memberof AuthController
 */
AuthController.resetPasswordHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = validationResult(req);
    if (!result.isEmpty()) {
        res
            .status(StatusCodes.BAD_REQUEST)
    ...
    try {
        ...
        if ((token === null || token === void 0 ? void 0 : token.status) && typeof token.msg === "object" && "email" in token.msg) {
